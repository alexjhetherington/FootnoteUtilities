...
public class FirstPersonKinematicBody : MonoBehaviour
{
    ...
    [SerializeField] private float mouseSensitivityVert = default;
    [SerializeField] private float mouseSensitivityHorz = default;

    [Header("References")]
    [SerializeField] private Transform camUpDown = default;
    [SerializeField] private Transform orientation = default;
